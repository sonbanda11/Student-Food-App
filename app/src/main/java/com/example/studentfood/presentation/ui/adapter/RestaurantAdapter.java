...
/**
 * RecyclerView adapter for Restaurant items
 */
public class RestaurantAdapter extends RecyclerView.Adapter<RestaurantAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_place_vertical, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        // Set basic info
        holder.txtName.setText(restaurant.getRestaurantName());
        
        // Set description (use address if no description available)
        if (restaurant.getLocation() != null && restaurant.getLocation().getAddress() != null) {
            holder.txtDescription.setText(restaurant.getLocation().getAddress());
        } else {
            holder.txtDescription.setText("Nhà hàng ngon gần bạn");
        }
